...
function TermsOfServiceText() {
  return (
    <>
      <h1 className='pageHeader'>Terms of Service</h1>
      <div className="pageContainer">
      <h2>Agreement to Terms</h2>
      <p>
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and Pippin
        Burkett, concerning your access to and use of the mobile application as
        well as any other media form, media channel, website or mobile
      ...
      <p>
        ...
        such registration information as necessary; you have the legal capacity
        and you agree to comply with these Terms of Use; you are not a minor in
        the jurisdiction in which you reside; you will not access the Site
        through automated or non-human means, whether through a bot, script, or
        otherwise; you will not use the Site for any illegal or unauthorized
        purpose; and your use of the Site will not violate any applicable law or
        regulation.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Systematically retrieving data or content from our Site to create a
          collection or database without written permission from us.
        </li>
        <li>
        ...
        <li>
          Circumvent, disable, or otherwise interfere with security-related
          features of our Site. This includes features that prevent/restrict the
          use of any content limits site usage.
        </li>
        <li>
          ...
          that interferes with any party's uninterrupted use of our Site and its
          features
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          rule. Your Contributions do not violate any applicable law concerning
          ...
          preference, disability or physical handicap.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        Policy:
        https://fullstack-accessibility-app.herokuapp.com/privacy-policy/
      </p>
      <p>
        ...
        hosted in United Kingdom. If you access the Site from any other region
        ...
        UK, then through your continued use of the Site, you are transferring
        your data to the UK and you agree to have your data transferred to and
        processed in the UK.{' '}
      </p>
      ...
      <p>
        ...
        the UK. and the use of the United Nations Convention of Contracts for
        ...
        your country of residence. Pippin Burkett and yourself both agree to
        ...
        rights in regards to these Conditions of Use in the UK.
      </p>
      ...
      <p>
        ...
        clause constitutes acceptance. The seat of arbitration shall be in
        London. The language of the proceedings shall be English. Applicable
        rules of substantive law shall be the law of United Kingdom.
      </p>
      <p>
      ...
      <p>
        ...
        USE YOUR BEST JUDGMENT WHERE APPROPRIATE
      </p>
      ...
      <p>
        ...
        made by any third party due to or arising out of use of the Site; breach
        of these Terms of Use; any breach of your representations and warranties
        set forth in these Terms of Use; violation of the rights of a third
        party, including but not limited to intellectual property rights; or any
      ...
      <p>
        ...
        information regarding use of the Site, please contact us at: hello (at)
        pippin.codes
      </p>
