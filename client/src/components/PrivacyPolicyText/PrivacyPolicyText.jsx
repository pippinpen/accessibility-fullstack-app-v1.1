  ...
  return (
    <>
      ...
      <div className="pageContainer">
        <p>
          This mobile application does not store any personal information other
          than your name and event information that is necessary for the app or
          to help improve the app itself.
        </p>
        <p>
          This privacy policy applies between you, the User of this Mobile
          Application, and Pippin Burkett, the owner and provider of this Mobile
          Application. We take the privacy of your information very seriously.
          This privacy policy applies to our use of any and all Data collected
          by us or provided by you in relation to your use of the Mobile
          Application.
        </p>
        <p>
        ...
        <p>
          User information is stored by Auth0 or third party providers where you
          sign on through Google, LinkedIn, GitHub or Figma.
        </p>
            ...
            <table>
              ...
              <tr>
                ...
                <tr>
                  <td>Data</td>
                  <td>
                    collectively all information that you submit to Pippin
                    Burkett via the Website. This definition incorporates, where
                ...
                <tr>
                  ...
                  <td>
                    ...
                    (i) employed by Pippin Burkett and acting in the course of
                    their employment or (ii) engaged as a consultant or
                    otherwise providing services to Pippin Burkett and accessing
                ...
                <tr>
                  ...
                  <td>
                    ...
                    using,https://fullstack-accessibility-app.herokuapp.com, and
                    any sub-domains of this site unless expressly excluded by
        ...
        <p>
          This prviacy policy applies only to the actions of Pippin Burkett and
          Users with respect to this Mobile Application. It does not extends to
          any websites that can be accessed from this Mobile Application
          including, but not limited to, any links to social media websites.
        </p>
        <p>
          For purposes of the applicable Data Protection Laws, Pippin Burkett is
          the "data controller". This means that Pippin Burkett determinds the
          purposes for which, and the manner in which, your Data is processed.
        </p>
        <h2>Data Collected</h2>
        <p>
          We may collect your name, information about your events and sessions
          on this mobile application in accordance with this privacy policy.
        </p>
        <h2>How we collect Data</h2>
        <p>
          We collect Data by data that is give to us by you and data that is
          collected automatically.
        </p>
        <h2>Data that is given to us by you</h2>
        <p>
          Pippin Burkett will collect your Data when you contact us through the
          mobile application and when you use our services in accordance with
          this policy.
        </p>
        <h2>Data that is collected automatically</h2>
        <p>
          When you access the mobile application, we will automatically collect
          some information about your visit to the mobile application. This
          information helps us to make improvements to Website content and
          navigation, and includes your IP address, the data, times and
          frequency with which you access the mobile application and the way you
        ...
        <p>
          ...
          when using our mobile application. Specifically Data may be used for
          internal record keeping and improvement of our products/services in
        ...
        <p>
          ...
          Data, for example: access to your account is controlled by a password
          and a user name that is unique to you and we store your Data on secure
          servers.
        </p>
        <p>
          ...
          contacting us via this e-mail address: hello (at) pippin.codes
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            this e-mail address: hello (at) pippin.codes.
          </li>
          <li>
        ...
        <ul>
          <li>
            Pippin Burkett may, from time to time, expand or reduce our business
            and this may involve the sale and/or the transfer of control of all
            or part of Pippin Burkett. Data provided by Users will, where it is
        ...
        <ul>
          ...
          <li>
            ...
            will be subject to the exclusive jurisdiction of the English and
            Welsh courts.
          </li>
        </ul>
        ...
        <ul>
          <li>
            Pippin Burkett reserves the right to change this privacy policy as
            ...
            Pippin Burkett by email at hello (at) pippin.codes.
          </li>
        </ul>
